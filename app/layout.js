          ...
          <div className='explore'>
            ...
            <div className="container_links">
              <div className="link">
                ...
                <Link href="/fccessories" className='links'>Accessories</Link>
                <Link href="/activewear" className='links'>Activewear</Link>
                <Link href="/gifts" className='links'>Gifts & Living</Link>
                <Link href="/inspiraton" className='links'>Inspiraton</Link>
              </div>
            </div>
          </div>
          {children}
